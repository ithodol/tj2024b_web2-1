...
// 주요 기능 및 어노테이션
// 1. @SpringBootConfiguration : @Configuration 어노테이션 포함하며, Spring 컨테이너(메모리)에 bean(객체) 설정을 등록할 수 있도록 도와주는 어노테이션
// 2. @EnableAutoConfiguration : Spring Boot가 자동으로 필요한 bean(객체)을 설정 
